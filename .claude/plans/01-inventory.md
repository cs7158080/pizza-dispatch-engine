...
are appended with a note of when. A `[open]` marker records the item's state **when it was
written** and is not maintained; current status is the table at the top of `02-decisions.md`,
